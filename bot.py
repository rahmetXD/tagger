...
api_id = int(os.environ.get("25114508"))
api_hash = os.environ.get("993ccdfe81548dade420e81bcd6807ce"")
bot_token = os.environ.get("6303797637:AAEIrMyCmvaseAgxWmI4nkmWm1ZtX4C_bLU")
